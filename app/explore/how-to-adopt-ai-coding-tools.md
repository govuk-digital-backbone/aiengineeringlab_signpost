...
<p class="govuk-body">If you're interested in adopting AI coding tools, AI Engineering Lab can help you.</p>

<p class="govuk-body">You'll start by assessing where your team is with AI coding tools. This is important to understand because organisations progress at different paces, with some moving quickly and others taking longer.</p>
  ...
  items: [
    {
      ...
      content: { html: "
        ...
        <p class='govuk-body'>A dedicated support team (forward deployed engineer, delivery manager, and change lead) will work with you. Forward deployed engineers join your teams, working alongside them on real code. Forward deployed engineers are trained in our change management framework to support and guide teams.</p>
        <p class='govuk-body'>Training is hands-on, including workshops, pairing sessions, and hackathons. We offer coaching to senior leaders and sponsors on our change management framework.</p>
        <p class='govuk-body'>We'll identify and develop AI champions in our change management framework, with protected time agreed. Our AI champion community will provide support throughout the adoption journey, including with engagement and communications. The change lead works on adoption blockers and addresses resistance. You'll connect to the cross-government community for peer support.</p>
        <h3 class='govuk-heading-s'>4. Embed and grow capability</h3>
        <p class='govuk-body'>Before direct support ends, you'll need to consider ongoing investment, including licence costs. Evidence gathered through the programme will support your business case. Adoption continues after our support ends, sustained by your champions, ongoing community connection, and access to guidance and resources.</p>
    ...
    },
    {
      ...
      content: { html: "
        <p class='govuk-body'>If your teams are already using AI coding tools confidently, we can help you build on what's working, connect you to the wider community, and access guidance and resources.</p>
