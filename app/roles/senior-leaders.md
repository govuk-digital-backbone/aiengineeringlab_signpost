    ...
    },
    {
      ...
      content: { html: "
        ...
        <ul class='govuk-list govuk-list--bullet'>
          ...
          <li>1-to-1 support to identify and mobilise AI champions in your organisation</li>
        ...
        <p class='govuk-body'><a href='/explore/how-to-adopt-ai-tools/' class='govuk-link'>Discover how to adopt AI tools</a> and how we can support you through it.</p>
      " }
    },
    {
