  ...
  items: [
    {
      ...
      content: { html: "
        ...
        <ul class='govuk-list govuk-list--bullet'>
          ...
          <li>supporting colleagues by answering questions and sharing techniques</li>
        ...
        <p class='govuk-body'>We provide support, training and resources to help you in this role.</p>
      " }
    },
    {
      heading: { text: "Support and resources" },
      content: { html: "
        <p class='govuk-body'>This programme supports:</p>
        <ul class='govuk-list govuk-list--bullet'>
    ...
    },
    {
      ...
      content: { html: "
       <p class='govuk-body'>Not everyone adopts new tools at the same pace. Our recommended <a href='#' class='govuk-link'>change management model</a> can help you understand and support individuals at different stages of their adoption journey.</p>
